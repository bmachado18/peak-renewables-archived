...
python train.py --img 1280 --batch-size 32 --epochs 200 --data wood_defects_1.yaml --weights yolov5l.pt --project $YOLO_OUT --name training-res --single-cls --hyp data/hyps/no-augmentation.yaml --freeze 23
